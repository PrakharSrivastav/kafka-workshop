package no.toyota.serviceautomation.kafkaoci;

import no.toyota.serviceautomation.kafkaoci.kafka.ConsentProducer;
...
public class Application implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        props.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, "cell-1.streaming.eu-frankfurt-1.oci.oraclecloud.com:9092");
        ...
        consumer.subscribe(Collections.singleton("PS_STREAM_TEST"));
